...
meteo_data = pd.read_csv(os.path.join('inputs', 'Darwinkel_open-meteo_since19101976.csv'), index_col='t')
...
def leaf_length_mstruct_area(dict_current_hz, df_control_hz, dict_current_elements, df_control_elements, tmin, tmax, pdf):
    ...
    for phyto_id in df_control_hz['metamer'].unique():
        ...
        # 4. Mstruct hz
        if phyto_id in (1, 2):
            axs[1][0].plot(df_control_elements[(df_control_elements.metamer == phyto_id) & (df_control_elements.element == 'LeafElement1')]['t'].unique(),
...
if __name__ == '__main__':
    ...
    simulations_paths = {
        ...
        # '100' : r"C:\Users\agrumel\Code\Python_Ecophy\WheatFspm\fspm-wheat\example\Darwinkel\darwinkel\GAIc_0.25_dens_100_delay_2.0_buf_0.5"
        '200' : r"C:\Users\agrumel\Code\Python_Ecophy\WheatFspm\fspm-wheat\example\Darwinkel\darwinkel\GAIc_0.25_dens_200_delay_2.0_buf_0.5"
        ,'250' : r"C:\Users\agrumel\Code\Python_Ecophy\WheatFspm\fspm-wheat\example\Darwinkel\darwinkel\GAIc_0.25_dens_250_delay_2.0_buf_0.5"
        ,'400' : r"C:\Users\agrumel\Code\Python_Ecophy\WheatFspm\fspm-wheat\example\Darwinkel\darwinkel\GAIc_0.25_dens_400_delay_2.0_buf_0.5"
        ,'800' : r"C:\Users\agrumel\Code\Python_Ecophy\WheatFspm\fspm-wheat\example\Darwinkel\darwinkel\GAIc_0.25_dens_800_delay_2.0_buf_0.5"

    }

    ### Path Control
    
    dirpath_control =r'C:\Users\agrumel\Code\Python_Ecophy\WheatFspm\fspm-wheat\example\emergence'

    

    OUTPUTS_CONTROL = os.path.join(dirpath_control, 'outputs')
